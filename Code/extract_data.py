...
def save_mfcc(dataset_path, json_path, num_mfcc=23, n_fft=2048, hop_length=512, num_segments=1):
    ...
    for i, (dirpath, dirnames, filenames) in enumerate(os.walk(dataset_path)):
		...
		# load audio file
                ...
                for d in range(num_segments):
                    ...
                    # extract mfcc
                    mfcc = feature.mfcc(y=signal[start:finish], sr=sample_rate, n_mfcc=num_mfcc, n_fft=n_fft, hop_length=hop_length)
                    mfcc = mfcc.T
