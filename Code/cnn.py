...
def build_model(input_shape):
    ...
    # 2nd conv layer
    model.add(keras.layers.Conv2D(32, (3, 3), activation='relu',kernel_regularizer=keras.regularizers.l2(0.1)))
    ...
    # 3rd conv layer
    model.add(keras.layers.Conv2D(32, (2, 2), activation='relu',kernel_regularizer=keras.regularizers.l2(0.1)))
...
def predict(model, X, y):
    labels_to_name={0:'SILENCE',1:'BABY LAUGH',2:'NOISE',3:'CRYING BABY'}
...
if __name__ == "__main__":
    ...
    # create network
    input_shape = (X_train.shape[1], X_train.shape[2], 1) #making input to 3d array(130,3,1)
